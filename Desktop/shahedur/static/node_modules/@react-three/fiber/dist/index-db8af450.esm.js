...
function createRenderer(_roots, _getEventPriority) {
  function createInstance(type, { args = [], attach, ...props }, root) {
    ...
    if (instance.__r3f.attach === undefined) {
      if (instance instanceof THREE.BufferGeometry)
        instance.__r3f.attach = "geometry";
      else if (instance instanceof THREE.Material)
    ...
    if (child) {
      ...
      if (!added)
        (_parentInstance$__r3f = parentInstance.__r3f) == null
          ? void 0
          : _parentInstance$__r3f.objects.push(child);
  ...
  function insertBefore(parentInstance, child, beforeChild) {
    ...
    if (child) {
      ...
      if (!added)
        (_parentInstance$__r3f2 = parentInstance.__r3f) == null
          ? void 0
          : _parentInstance$__r3f2.objects.push(child);
      if (!child.__r3f) prepare(child, {});
      child.__r3f.parent = parentInstance;
      updateInstance(child);
      invalidateInstance(child);
  ...
  function removeChild(parentInstance, child, dispose) {
    if (child) {
      ...
      if (
        (_parentInstance$__r3f3 = parentInstance.__r3f) != null &&
        _parentInstance$__r3f3.objects
      )
      ...
      const isPrimitive =
        (_child$__r3f5 = child.__r3f) == null
          ? void 0
          : _child$__r3f5.primitive;
      const shouldDispose =
        !isPrimitive &&
        (dispose === undefined ? child.dispose !== null : dispose);
      ...
      if (!isPrimitive) {
        var _child$__r3f6;
        removeRecursive(
          (_child$__r3f6 = child.__r3f) == null
            ? void 0
            : _child$__r3f6.objects,
          child,
          shouldDispose
        );
  ...
  function switchInstance(instance, type, newProps, fiber) {
    var _instance$__r3f;
    const parent =
      (_instance$__r3f = instance.__r3f) == null
        ? void 0
        : _instance$__r3f.parent;
    if (!parent) return;
  ...
  const reconciler = Reconciler({
    ...
    finalizeInitialChildren(instance) {
      ...
      const localState =
        (_instance$__r3f2 = instance == null ? void 0 : instance.__r3f) != null
          ? _instance$__r3f2
          : {};
    ...
    getCurrentEventPriority: () =>
      _getEventPriority ? _getEventPriority() : DefaultEventPriority,
 ...
 */
const hasColorSpace = (object) =>
  "colorSpace" in object || "outputColorSpace" in object;
/**
 * The current THREE.ColorManagement instance, if present.
 */
const getColorManagement = () => {
  var _ColorManagement;
  return (_ColorManagement = catalogue.ColorManagement) != null
    ? _ColorManagement
    : null;
};
...
function detach(parent, child, type) {
  ...
  if (is.str(type)) {
    ...
    (_child$__r3f = child.__r3f) == null
      ? void 0
      : _child$__r3f.previousAttach == null
      ? void 0
      : _child$__r3f.previousAttach(parent, child);
  (_child$__r3f2 = child.__r3f) == null
    ? true
    : delete _child$__r3f2.previousAttach;
}
...
function applyProps$1(instance, data) {
  ...
  const localState =
    (_instance$__r3f3 = instance.__r3f) != null ? _instance$__r3f3 : {};
...
function getEventPriority() {
  ...
  const name =
    (_globalScope$event = globalScope.event) == null
      ? void 0
      : _globalScope$event.type;
  switch (name) {
    case "click":
    case "contextmenu":
    case "dblclick":
...
function createEvents(store) {
  ...
  function intersect(event, filter) {
      ...
      if (state.raycaster.camera === undefined) {
        ...
        state.events.compute == null
          ...
          : state.events.compute(
              event,
              state,
              (_state$previousRoot = state.previousRoot) == null
                ? void 0
                : _state$previousRoot.getState()
            );
    ...
    if (
      "pointerId" in event &&
      state.internal.capturedMap.has(event.pointerId)
    ) {
  ...
  function pointerMissed(event, objects) {
    for (let i = 0; i < objects.length; i++) {
      ...
      instance == null
        ? void 0
        : instance.handlers.onPointerMissed == null
        ? void 0
...
const createStore = (invalidate, advance) => {
  ...
  rootState.subscribe(() => {
    ...
    if (
      ...
      const updateStyle =
        (_size$updateStyle = size.updateStyle) != null
          ? _size$updateStyle
          : typeof HTMLCanvasElement !== "undefined" &&
            gl.domElement instanceof HTMLCanvasElement;
...
function createLoop(roots) {
  ...
  function loop(timestamp) {
    ...
    for (const root of roots.values()) {
      ...
      if (
        ...
        !((_state$gl$xr = state.gl.xr) != null && _state$gl$xr.isPresenting)
      ) {
  ...
  function invalidate(state, frames = 1) {
    var _state$gl$xr2;
    if (!state)
      return roots.forEach((root) => invalidate(root.store.getState()), frames);
    if (
      ((_state$gl$xr2 = state.gl.xr) != null && _state$gl$xr2.isPresenting) ||
      !state.internal.active ||
...
function useInstanceHandle(ref) {
  ...
  useIsomorphicLayoutEffect(
    () => void (instance.current = ref.current.__r3f),
    [ref]
  );
  return instance;
}
...
function loadingFn(extensions, onProgress) {
  return function (Proto, ...input) {
    ...
    ).finally(() => (loader.dispose == null ? void 0 : loader.dispose()));
  };
}
...
function createRoot(canvas) {
  ...
  return {
    configure(props = {}) {
      ...
      if (
        !state.camera ||
        (state.camera === lastCamera &&
          !is.equ(lastCamera, cameraOptions, shallowLoose))
      ) {
        ...
        if (!isCamera) {
          ...
          if (
            !state.camera &&
            !(cameraOptions != null && cameraOptions.rotation)
          )
            camera.lookAt(0, 0, 0);
        }
        state.set({
      ...
      if (!state.xr) {
        ...
        if (
          typeof ((_gl$xr = gl.xr) == null
            ? void 0
            : _gl$xr.addEventListener) === "function"
        )
          xr.connect();
        state.set({
          xr,
      ...
      if (gl.shadowMap) {
        ...
        if (is.boo(shadows)) {
          ...
          gl.shadowMap.type =
            (_types$shadows = types[shadows]) != null
              ? _types$shadows
...
function Portal({ state = {}, children, container }) {
  ...
  const inject = React.useCallback(
    (rootState, injectState) => {
      ...
      if (injectState && size) {
        ...
        viewport = rootState.viewport.getCurrentViewport(
          camera,
          new THREE.Vector3(),
          size
        );
  ...
  React.useEffect(() => {
    ...
    const unsub = previousRoot.subscribe((prev) =>
      usePortalStore.setState((state) => inject(prev, state))
    );
    return () => {
      unsub();
  ...
  React.useEffect(() => {
    usePortalStore.setState((injectState) =>
      inject(previousRoot.getState(), injectState)
    );
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [inject]);
  return /*#__PURE__*/ React.createElement(
...
export {
  ...
  addAfterEffect as o,
  addTail as p,
  flushGlobalEffects as q,
  render as r,
  getRootState as s,
  threeTypes as t,
  useMutableCallback as u,
  act as v,
  buildGraph as w,
  roots as x,
  useInstanceHandle as y,
  useStore as z,
};
