...
function useEnvironment({
  ...
  extension = isArray(files)
    ...
    ? "hdr"
    : (_files$split$pop = files.split(".").pop()) == null ||
      (_files$split$pop = _files$split$pop.split("?")) == null ||
      (_files$split$pop = _files$split$pop.shift()) == null
    ? void 0
    : _files$split$pop.toLowerCase();
  loader = isCubeMap
    ? CubeTextureLoader
    : extension === "hdr"
    ? RGBELoader
  ...
  if ("colorSpace" in texture)
    texture.colorSpace = (
      encoding !== null && encoding !== void 0 ? encoding : isCubeMap
    )
      ? "srgb"
      : "srgb-linear";
  else
