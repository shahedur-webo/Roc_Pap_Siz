...
export class RawColliderSet {
  ...
  coContactForceEventThreshold(handle) {
    const ret = wasm.rawcolliderset_coContactForceEventThreshold(
      this.ptr,
      handle
    );
    return ret;
  ...
  coSetMassProperties(
    ...
    wasm.rawcolliderset_coSetMassProperties(
      ...
      mass,
      centerOfMass.ptr,
      principalAngularInertia.ptr,
      angularInertiaFrame.ptr
    );
  }
  /**
   */
...
export class RawContactManifold {
  ...
  solver_contact_tangent_velocity(i) {
    const ret = wasm.rawcontactmanifold_solver_contact_tangent_velocity(
      this.ptr,
      i
    );
    return RawVector.__wrap(ret);
...
export class RawIntegrationParameters {
  ...
  get maxVelocityFrictionIterations() {
    const ret = wasm.rawintegrationparameters_maxVelocityFrictionIterations(
      this.ptr
    );
    return ret >>> 0;
  }
  ...
  get maxStabilizationIterations() {
    const ret = wasm.rawintegrationparameters_maxStabilizationIterations(
      this.ptr
    );
    return ret >>> 0;
  }
...
export class RawMultibodyJointSet {
   ...
   */
  jointContactsEnabled(handle) {
    const ret = wasm.rawmultibodyjointset_jointContactsEnabled(
      this.ptr,
      handle
    );
    return ret !== 0;
...
export class RawSerializationPipeline {
   ...
   */
  deserializeAll(data) {
    const ret = wasm.rawserializationpipeline_deserializeAll(
      this.ptr,
      addHeapObject(data)
    );
...
function getImports() {
  ...
  imports.wbg.__wbg_call_8e1338b908441bd2 = function () {
  ...
  imports.wbg.__wbg_call_0a54fa4fb42023f0 = function () {
  ...
  imports.wbg.__wbg_newwithbyteoffsetandlength_9ca61320599a2c84 = function (
    arg0,
    arg1,
    arg2
  ) {
  ...
  imports.wbg.__wbg_newwithbyteoffsetandlength_b0ff18b468a0d3f8 = function (
    arg0,
    arg1,
    arg2
  ) {
